...
const skins: Record<string, Skin> = {
  ...
  DHL_UI: {
    logo: 'https://kombijdhl.nl/wp-content/uploads/2024/04/DHL_Supply_Chain_logo_rgb_BG.png',
    colors: {
      // Base colors
      background: '#FFFFFF',
      foreground: '#121212',
  ...
  BIAL_UI: {
    logo: 'https://www.airport-suppliers.com/wp-content/uploads/2021/11/Kempegowda_International_Airport_Bengaluru_Logo.svg.png',
    colors: {
      // Base colors
      background: '#FFFFFF',
      foreground: '#121212',
  ...
  AMS_UI: {
    logo: 'https://oemfile.informamarkets-info.com/FileUpload/2024MTV_37144/20240603133615187.png',
    colors: {
      // Base colors
      background: '#FFFFFF',
      foreground: '#121212',
