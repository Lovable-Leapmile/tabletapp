...
const AdminAddProduct = () => {
  ...
  const handleConfirmItem = async () => {
    ...
    try {
      ...
      const response = await authenticatedFetch(getApiUrl(`/nanostore/item?item_id=${encodeURIComponent(itemId)}&item_description=${encodeURIComponent(itemDescription)}`), {
        method: 'POST'
      });
