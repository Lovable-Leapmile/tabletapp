      ...
      <AlertDialog open={showConfirm} onOpenChange={setShowConfirm}>
        <AlertDialogContent className="max-w-md l-4 r-4 sm:mx-0 sm:l-0 sm:r-0 max-w-[calc(100vw-2rem)] sm:max-w-md">
          <AlertDialogHeader className="text-center">
            <AlertDialogTitle className="text-foreground text-center">Confirm Bin Selection</AlertDialogTitle>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-center gap-4 py-2">
                  ...
                  <button
                    ...
                    className="p-3 rounded-full bg-background border border-input hover:bg-accent hover:text-accent-foreground disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                  >
