  ...
  return (
    <div className="mobile-full-height flex flex-col bg-background overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto touch-scroll no-pull-refresh mobile-app-bar-padding">
        <div className="container mx-auto mobile-content-padding py-6 sm:py-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-6">
              <Card
                ...
                className="p-6 sm:p-8 cursor-pointer transition-smooth active:scale-[0.98] bg-primary border-none shadow-md animate-fade-in animation-delay-0"
              >
            ...
            <Collapsible open={adminOpen} onOpenChange={setAdminOpen}>
              <CollapsibleTrigger asChild>
                <div className="flex items-center justify-between bg-primary rounded-xl px-5 py-3 cursor-pointer transition-smooth active:scale-[0.99] shadow-sm">
                  <div className="flex items-center gap-2">
                    <UserCog className="w-5 h-5 text-primary-foreground" />
                    <span className="text-base sm:text-lg font-semibold text-primary-foreground">Admin</span>
                  </div>
                  <ChevronDown className={`w-5 h-5 text-primary-foreground transition-transform duration-200 ${adminOpen ? 'rotate-180' : ''}`} />
                </div>
              </CollapsibleTrigger>
